...
workbox.precaching.precacheAndRoute([{"revision":"201438546c11219e00cbd4ece66cc25c","url":"./404.html"},{"revision":"3082efe602d7013fe1ab385ded86a565","url":"./index.html"},{"revision":"e8b70d1f5c969078e425cdb153a88da3","url":"./css/index.css"},{"revision":"2ae4a96698c1ccefbf26f1035f22f43c","url":"./offline.html"}],{
    directoryIndex: null
});
...
const npm = async (req) => {
    ...
    if (domain.match("npm.elemecdn.com")) {
        return fetch(req.url.replace("https://npm.elemecdn.com", "https://cdn.afdelivr.top/npm"));
    }
    else {
        return fetch(req)
    }
...
let cdn = {//镜像列表
    ...
    "combine": {
        ...
        mrzefr: {
            "url": "https://jsd.mrzefr.cn/combine"
        }
    },
    "npm": {
        arcitcgn: {
        ...
        mrzefr: {
            "url": "https://jsd.mrzefr.cn/npm"
        }
    }
}
const cache_url_list = [
    /(http:\/\/|https:\/\/)cdn\.afdelivr\.top/g,

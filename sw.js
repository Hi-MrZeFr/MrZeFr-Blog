...
workbox.precaching.precacheAndRoute([{"revision":"ae65dbc253e4fee7a55ffa05c130d85c","url":"./404.html"},{"revision":"9a910dd6f87acaf618ea40b59d64d5ae","url":"./index.html"},{"revision":"2fa95417a9a4496b7e24cce52d1a54d4","url":"./css/index.css"},{"revision":"59336b7436728cc8c2ce83402bd6b898","url":"./offline.html"}],{
    directoryIndex: null
});
...
const handle = async (req) => {
    ...
    if (domain === "blog.mrzefr.cn") {
        ...
        if (urlStr.match(/\/cdn\-cgi/g)) {
            return new Response('Our CDN is provided by Tianyu Cloud CDN', { status: 200 })
        }

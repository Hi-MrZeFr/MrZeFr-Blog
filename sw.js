...
workbox.precaching.precacheAndRoute([{"revision":"36b96d34e57a9c9460a7e38873f6c16d","url":"./404.html"},{"revision":"e0b6028f51046829b099fa9da0e1f449","url":"./index.html"},{"revision":"021de3db66381d9a8515d5a196f4389b","url":"./css/index.css"},{"revision":"59336b7436728cc8c2ce83402bd6b898","url":"./offline.html"}],{
    directoryIndex: null
});
...
const npm = async (req) => {
    ...
    if (domain.match("cdn.jsdelivr.net")) {
        return fetch(req.url.replace("https://cdn.jsdelivr.net", "https://jsd.mrzefr.cn"));
    }
    else {
        return fetch(req)
    }
